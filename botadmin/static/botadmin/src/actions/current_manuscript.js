import {
  ...
  CHANGE_MANUSCRIPT_ITEM_PROPERTY, CHANGE_MANUSCRIPT_PROPERTY, CREATE_MANUSCRIPT, DELETE_MANUSCRIPT_ALTERNATIVE,
  DELETE_MANUSCRIPT_ITEM,
  EDIT_MANUSCRIPT,
...
export const deleteManuscriptAlternative = (alternativeIndex) => {
  return {
    type: DELETE_MANUSCRIPT_ALTERNATIVE,
    alternativeIndex
  };
};
